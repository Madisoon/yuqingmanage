...
public class YuQingAppService implements IYuQingService {
        ...
        if (execResult.getResult() == 1) {
            ...
            if (password.equals(userPwd)) {
                ...
                if (userOverDue.compareTo(nowTime) > 0) {
                    ...
                    jsonObjectUser.put("token", "loginName");
    ...
    public JSONObject searchMenus() {
        String getSMenus = "SELECT a.id AS tag_id,a.app_program_name AS NAME,b.app_module_type AS TYPE  " +
                ...
                "LEFT JOIN app_user_program_module b ON a.id=b.app_program_id) a  " +
    ...
    @Override
    public JSONObject searchTagInfo(String filters, int limit, String date) {
        if ("".equals(date)) {
    ...
    public JSONObject searchFavor(int limit, String date) {
        String getFavorInfo = "SELECT b.infor_type AS level_id,b.infor_title " +
                ...
                "WHERE a.app_user_loginname = 'admin' ";
        return null;
    }
    ...
    public JSONObject removeFavor(String id) {
        ...
        if ("".equals(id)) {
            removeFavorSql = "DELETE FROM app_user_favor WHERE app_user_loginname = ''";
        } else {
    ...
    public JSONObject updatePwd(String oldPwd, String newPwd) {
        String sqlPwd = "UPDATE app_user a SET a.app_user_pwd = '" + newPwd + "' " +
                "WHERE a.app_user_loginname = '" + newPwd + "' AND a.app_user_pwd = '" + oldPwd + "'";
        return null;
    }
